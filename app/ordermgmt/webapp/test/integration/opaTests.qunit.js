...
sap.ui.require(
  [
    ...
    "com/demo/ordermgmt/test/integration/OrdersListJourney",
    "com/demo/ordermgmt/test/integration/OrdersObjectPageJourney",
    "com/demo/ordermgmt/test/integration/OrderItemsObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
